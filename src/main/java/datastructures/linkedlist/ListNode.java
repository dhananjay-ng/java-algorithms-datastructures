...
public class ListNode<T> {
    ...
    public ListNode<T> search(ListNode<T> startNode, T key) {
    ...
    public void insertAfter(ListNode<T> source, ListNode<T> toBeInsertedNode) {
        toBeInsertedNode.next = source.next;
        source.next = toBeInsertedNode;
    }

    public  void deleteNode(ListNode<T> toBeDeleted){
